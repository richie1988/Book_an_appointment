...
const[categoryList, setCategoryList]= useState([]);
  ...
  return (
    ...
    <Link key={index} href={'/search/'+item.attributes.Name} className='flex flex-col text-center items-center p-5 bg-blue-50 m-2 rounded-lg gap-2 cursor-pointer hover:scale-105 transition-all easy-in-out'>
